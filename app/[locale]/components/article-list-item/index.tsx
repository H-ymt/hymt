import ConvertDate from '@/app/[locale]/components/convert-date'
...
export default function ArticleListItem({ posts }: ArticleListItemProps) {
  return (
    <TransitionLink key={posts?.id} href={`https://zenn.dev/${posts?.path}`} target="_blank" className={styles.item}>
